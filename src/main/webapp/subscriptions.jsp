...
<body>
    ...
    <div style="padding: 20px;">
        ...
        <p>Channels you are subscribed to</p>
        
        <c:if test="${empty subscribedChannels}">
            <div style="text-align: center; padding: 40px;">
                <p>You haven't subscribed to any channels yet.</p>
                <p>Explore videos and subscribe to your favorite channels!</p>
                <a href="home" class="view-channel-btn">Browse Videos</a>
            </div>
        </c:if>
